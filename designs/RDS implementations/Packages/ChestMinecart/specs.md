...
The chest minecart Package technology fully support the [**Standard RDS Protocol**](/docs/rds/rds_protocols.md#the-standard-rds-protocol), and can therefore be used in RDS-compliant networks.
