...
## Contributing
If you are a redstone engineer / creator, and would like to contribute by providing your own redstone implementation of a RDS entity, feel free to fork and clone the repo, and adding your design by making a pull request!
...
You can also contribute by improving or adding newer documentation. If the documentation you are adding is tighly RDS-coupled, then it makes for it to live near all the other official documentation files, inside the `/docs` folder.  
